...
//   const []
  ...
  const getData = (users) => {
    let cash_deposit=0,cash_withdrawal=0,rtgs=0;
    users.map((user) => {
      if (
      ...
      parseInt(user.Debit) >= 50000){
          cash_withdrawal++;
      }else if(user.FirstLevelClassification == "RTGS Receipt" &&
  ...
  return (
    ...
    <NavbarComponent/>
      <div className="parent">
        <div className="mains">
          <h3>Summary of Expectional Transactions</h3>
          <Table striped>
            <thead>
              <tr>
                <th>Date</th>
            ...
            <tbody>
              ...
              <tr>
                <td>Cash Withdrwal &gt;= 50% of Average Income</td>
                <td>56</td>
              </tr>
              <tr>
